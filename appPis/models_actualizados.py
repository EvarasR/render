...
class Configuracionelementofundamentalfuentedeinformaciondocumentos(models.Model):
    codmodelo = models.OneToOneField('Detalleelementofundamentalfuentedeinformacion', models.DO_NOTHING, db_column='codmodelo', primary_key=True)  # The composite primary key (codmodelo, codcriterio, codsubcriterio, codindicador, codelementofundamental, codfuentedeinformacion, coddetalleelementofundamentalfuentedeinformacion, coddconfiguracionelementofundamentalfuentedeinformaciondocument) found, that is not supported. The first column is selected.
    ...
    coddconfiguracionelementofundamentalfuentedeinformaciondocument = models.BigAutoField(unique=True)
    ...
    class Meta:
        ...
        unique_together = (('codmodelo', 'codcriterio', 'codsubcriterio', 'codindicador', 'codelementofundamental', 'codfuentedeinformacion', 'coddetalleelementofundamentalfuentedeinformacion', 'coddconfiguracionelementofundamentalfuentedeinformaciondocument'),)
...
class Criterios(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'criterios'
        unique_together = (('codmodelo', 'codcriterio'), ('codmodelo', 'nombre'), ('codmodelo', 'codcriterio'),)


class Detalleelementofundamentalfuentedeinformacion(models.Model):
    codmodelo = models.OneToOneField('Fuentedeinformacion', models.DO_NOTHING, db_column='codmodelo', primary_key=True)  # The composite primary key (codmodelo, codcriterio, codsubcriterio, codindicador, codelementofundamental, codfuentedeinformacion, coddetalleelementofundamentalfuentedeinformacion) found, that is not supported. The first column is selected.
    codcriterio = models.IntegerField()
    codsubcriterio = models.IntegerField()
    codindicador = models.IntegerField()
    codelementofundamental = models.IntegerField()
    codfuentedeinformacion = models.IntegerField()
    coddetalleelementofundamentalfuentedeinformacion = models.BigAutoField()

    class Meta:
        managed = False
        db_table = 'detalleelementofundamentalfuentedeinformacion'
        unique_together = (('codmodelo', 'codcriterio', 'codsubcriterio', 'codindicador', 'codelementofundamental', 'codfuentedeinformacion', 'coddetalleelementofundamentalfuentedeinformacion'), ('codmodelo', 'codcriterio', 'codsubcriterio', 'codindicador', 'codelementofundamental', 'codfuentedeinformacion'),)
...
class Evaluadorescriterio(models.Model):
    ...
    codusuario = models.ForeignKey('Usuarios', models.DO_NOTHING, db_column='codusuario')
    codfacultad = models.ForeignKey(Carreras, models.DO_NOTHING, db_column='codfacultad')
    codcarrera = models.IntegerField()
    codmodelo = models.ForeignKey(Criterios, models.DO_NOTHING, db_column='codmodelo')
    codcriterio = models.IntegerField()
...
class Indicadores(models.Model):
    codmodelo = models.OneToOneField('Subcriterios', models.DO_NOTHING, db_column='codmodelo', primary_key=True)  # The composite primary key (codmodelo, codcriterio, codsubcriterio, codindicador) found, that is not supported. The first column is selected.
    codcriterio = models.IntegerField()
    codsubcriterio = models.IntegerField()
    codindicador = models.IntegerField()
    codtipoindicador = models.ForeignKey('Tipoindicador', models.DO_NOTHING, db_column='codtipoindicador')
    codperiodoevaluacion = models.ForeignKey('Periodoevaluacion', models.DO_NOTHING, db_column='codperiodoevaluacion', blank=True, null=True)
    nombre = models.CharField(max_length=100)
    descripcion = models.TextField(blank=True, null=True)
    ...
    codestadoindicador = models.ForeignKey(Estados, models.DO_NOTHING, db_column='codestadoindicador', blank=True, null=True)
    valor_maximo = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'indicadores'
        unique_together = (('codmodelo', 'codcriterio', 'codsubcriterio', 'codindicador'), ('codmodelo', 'codcriterio', 'codsubcriterio', 'nombre'),)
...
class Medicionelementofundamental(models.Model):
    codfacultad = models.OneToOneField(Evaluaciones, models.DO_NOTHING, db_column='codfacultad', primary_key=True)  # The composite primary key (codfacultad, codcarrera, codevaluacion, codmodelo, codcriterio, codsubcriterio, codindicador, codelementofundamental, codmedicionelementofundamental, codfuentedeinformacion) found, that is not supported. The first column is selected.
    codcarrera = models.IntegerField()
    codevaluacion = models.IntegerField()
    ...
    codelementofundamental = models.IntegerField()
    codfuentedeinformacion = models.IntegerField()
    codmedicionelementofundamental = models.BigAutoField()
...
class Medidorelementofundamentalfuenteinformaciondocumentos(models.Model):
    codmodelo = models.IntegerField()
    codcriterio = models.IntegerField()
    codsubcriterio = models.IntegerField()
    codindicador = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'medidorelementofundamentalfuenteinformaciondocumentos'
...
class Periodoevaluacion(models.Model):
    ...
    numerociclo = models.IntegerField(blank=True, null=True)
...
class Puntajeindicador(models.Model):
    codfacultad = models.OneToOneField(Evaluaciones, models.DO_NOTHING, db_column='codfacultad', primary_key=True)  # The composite primary key (codfacultad, codcarrera, codevaluacion, codmodelo, codcriterio, codsubcriterio, codindicador, codpuntajeindicador) found, that is not supported. The first column is selected.
    codcarrera = models.IntegerField()
    codevaluacion = models.IntegerField()
    codmodelo = models.ForeignKey(Indicadores, models.DO_NOTHING, db_column='codmodelo')
    codcriterio = models.IntegerField()
    codsubcriterio = models.IntegerField()
    codindicador = models.IntegerField()
    codpuntajeindicador = models.BigAutoField()
    fecharegistro = models.DateTimeField(blank=True, null=True)
    ...
    class Meta:
        ...
        unique_together = (('codfacultad', 'codcarrera', 'codevaluacion', 'codmodelo', 'codcriterio', 'codsubcriterio', 'codindicador', 'codpuntajeindicador'),)
...
class Responsablesindicador(models.Model):
    ...
    codcarrera = models.IntegerField()
    codindicador = models.IntegerField()
    codresponsable = models.BigAutoField(primary_key=True)
    codusuario = models.ForeignKey('Usuarios', models.DO_NOTHING, db_column='codusuario')
    nombrecarrera = models.TextField()
    nombreindicador = models.TextField()
...
class Seguimientos(models.Model):
    codfacultad = models.ForeignKey(Acciones, models.DO_NOTHING, db_column='codfacultad', to_field='codfacultad')
    codcarrera = models.IntegerField()
    codevaluacion = models.IntegerField()
    codplanmejora = models.IntegerField()
    ...
    class Meta:
        ...
        unique_together = (('codfacultad', 'codcarrera', 'codevaluacion', 'codplanmejora', 'codaccion', 'codseguimiento'),)
...
class TmpResponsables(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'tmp_responsables'


class Usuarios(models.Model):
    codrol = models.ForeignKey(Roles, models.DO_NOTHING, db_column='codrol')
    codusuario = models.IntegerField(primary_key=True)
    ...
    codfacultad = models.ForeignKey(Carreras, models.DO_NOTHING, db_column='codfacultad', blank=True, null=True)
    codcarrera = models.IntegerField(blank=True, null=True)
